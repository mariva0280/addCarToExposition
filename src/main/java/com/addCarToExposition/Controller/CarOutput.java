...
public class CarOutput {
    ...
    public CarOutput(String matricula, String modelo,String marca,int anyo) throws InvalidCarFieldException {
        ...
        if(marca.trim().isEmpty()) throw new InvalidCarFieldException("The car brand cannot be empty");
        this.marca=marca;
        this.anyo = anyo;
    }
    public static CarOutput getCarOutput(CarInput carInput) throws InvalidCarFieldException {
        return new CarOutput(carInput.getMatricula(), carInput.getModelo(),carInput.getMarca(),carInput.getAnyo());
    }
